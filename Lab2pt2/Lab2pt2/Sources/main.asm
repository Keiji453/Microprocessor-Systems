;********************************************************************
;* LCD Output program                                               *
;* This program displays one NULL terminated string to the LCD      *
;* followed by 2 hexadecimal numbers.
...
; Include derivative-specific definitions 
		        ...
		        ORG   $3000
content1    FCB   $4A ; Sets data at $3000
content2    FCB 	$4B	; Sets data at $3001        
mem1        RMB   1
mem2        RMB   1
mem3        RMB   1
mem4        RMB   1
...
MainLoop    JSR   clrLCD    ; clear LCD & home cursor
            ...
            LDAA  content2  ; load contents at $3001 into A
            JSR   leftHLF   ; convert left half of A into ASCII
            ...
            JSR   del_50us
            BRA   MainLoop  ; Loop
msg1        dc.b  "Joaquin Kataoka ",0;Defines constant data block
;subroutine section
;*******************************************************************
...
cmd2LCD:    BCLR  LCD_CNTR,LCD_RS ; select the LCD Instruction Register (IR)
            ...
            RTS
;*******************************************************************
;* This function outputs a NULL-terminated string pointed to LCD   *
;* Essentially, deconstructs String in X by each character and     *
;* send it to LCD                                                  *
;*******************************************************************
...
rightHLF    ANDA  #$0F  ; mask top half
            ...
            CMPA  #$39  ; Below: Branch if A <= $39
            BLE   out   ; jump if 0-9
            ADDA  #$07  ; convert to hex A-F (Adds 7 to A for conversion)
out         RTS
